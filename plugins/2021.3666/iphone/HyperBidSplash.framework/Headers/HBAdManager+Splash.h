...
//extern NSString *const kHBSplashExtraConfigKey;
...
- (void)loadAd:(NSString *)placementID extra:(NSDictionary *)extra delegate:(id<HBSplashDelegate>)delegate containerView:(UIView *)containerView defaultAdSourceConfig:(NSString *)defaultAdSourceConfig;
