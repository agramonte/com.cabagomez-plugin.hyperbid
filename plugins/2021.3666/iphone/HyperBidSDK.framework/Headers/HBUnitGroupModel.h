...
typedef NS_ENUM(NSInteger, HBShowAutoLoadType) {
    HBShowAutoOneAdSupportLoadType = 1,
    HBShowAutoOneAdNotSupportLoadType,
    HBShowAutoOneNetWorkNotSupportLoadType,
};
...
@property(nonatomic, assign) HBShowAutoLoadType showAutoLoadType;
