 ...
 */
-(void)sendHBWinnerNotificationForBidInfo:(HBBidInfo *)bidInfo nextUnitGroupPrice:(NSString *)nextPrice;
...
-(void)sendHBLossNotificationForBidInfo:(HBBidInfo *)bidInfo price:(NSString*)price headerBidding:(BOOL)headerBidding winnerNetworkFirmID:(NSInteger)winnerNetworkFirmID requestID:(NSString*)requestID;
